...
const multer = require("multer"); // to store the pics in our database
const path = require("path"); // access to our backend directory in express
const cors = require("cors");

app.use(express.json()); 
app.use(cors()); // connecting express app to port 5000

// Database connection with MongoDB
mongoose.connect("mongodb+srv://Amrah:Groot@cluster0.fzyyn1j.mongodb.net/e-commerce", {
...
//creating endpoint for newcollection dat
